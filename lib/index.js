...
export default class IranRegionWheelPicker extends BaseComponent {
    ...
    renderPicker() {
        ...
        return ( <
                ...
                <View style={
                    [styles.pickerContainer, isIos ? {} : {marginTop: windowHeight - 80 - this.props.androidPickerHeight}] }>
                    <View style={ styles.navWrap }>
                        <TouchableOpacity style={
                            ...
                            <Text style={
                                [styles.text, {color: navBtnColor}] }> لغو
                            </Text>
                        </TouchableOpacity> <
                        TouchableOpacity style={
    ...
    render() {
        const modal = ( <Modal transparent={ this.state.transparent }
